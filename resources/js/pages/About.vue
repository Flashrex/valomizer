<template>
  <Head title="About" />
  <div class="w-full h-full flex flex-col justify-center items-center text-primary gap-8">
    ...
    <section class="flex flex-col justify-center items-center p-4">
      ...
      <p class="text-sm">{{ t('If you want to contribute to this project, you can find the source code on') }} <a class="link"
